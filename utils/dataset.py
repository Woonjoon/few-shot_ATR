...
from .file_io import load_csv_file, write_pickle_file
...
def pack_dataset_to_hdf5(dataset):
    ...
    for split in splits:
        csv_path = 'datasets/{}/csv_files/{}.csv'.format(dataset, split)
        audio_dir = 'datasets/{}/waveforms/{}/'.format(dataset, split)
        hdf5_path = 'datasets/{}/hdf5s/{}/'.format(dataset, split)
    ...
    write_pickle_file(words_list, 'datasets/{}/pickles/words_list.p'.format(dataset))
